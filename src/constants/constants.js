export const projects = [
  {
    title: 'Instagram',
    description: "Instagram is a well known social media platform owned by meta where users can share pictures and videos with captions and emojis.",
      image: '/images/0.png',
  ...
  },
  {
    ...
    description:"Juicy Chemistry is an e-commerce web application for personal care. It aims to help everyone find the answers to their skin concerns.",
    image: '/images/2.png',
